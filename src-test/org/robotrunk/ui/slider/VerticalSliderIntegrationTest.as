package org.robotrunk.ui.slider {
	...
	public class VerticalSliderIntegrationTest {
		[Inject]
		public var injector:Injector;

		[Inject(name="slider", kind="slider", style="vertical", map="slider")]
		...
		public function checkObjectCreation():void {
			...
			var provider:UIComponentProvider = context.injector.getInstance( UIComponentProvider,
																			 getQualifiedClassName( VerticalSliderImpl ) );
			...
			assertThat( instanceOf( VerticalSliderImpl ), slider );
		}
	}
}
