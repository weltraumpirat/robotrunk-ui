package org.robotrunk.ui.slider.factory {
	...
	public class VerticalSliderFactoryTest {
		private var factory:VerticalSliderFactory;
		...
		public function setUp():void {
			factory = new VerticalSliderFactory();
		}
		...
		public function createsSlider():void {
			...
			mockDependencies();
			mockButtonFactory();
			assertThat( factory.create( injector, params ), instanceOf( VerticalSliderImpl ) );
		}
		...
		private function mockDependencies():void {
			...
			mock( injector ).method( "getInstance" ).args( VerticalSliderImpl ).returns( new VerticalSliderImpl() );
