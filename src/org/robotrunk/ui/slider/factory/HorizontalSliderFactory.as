package org.robotrunk.ui.slider.factory {
	...
	public class HorizontalSliderFactory extends AbstractSliderFactory {
		[Inject]
		public var buttonFactory:SliderButtonFactory;

		override protected function getSliderInstance():Slider {
			return parameters.injector.getInstance( HorizontalSliderImpl );
		}
		...
		public function HorizontalSliderFactory() {
